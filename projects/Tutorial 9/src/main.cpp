...
bool initGLFW() {
	...
	window = glfwCreateWindow(800, 800, "Kimberly Hansuwan 100752265 Tutorial 9", nullptr, nullptr);
...
// Load some textures from files
	...
	// Create a material and set some properties for it
		...
		material0->Set("s_Reflection", reflectivity);
		material0->Set("s_Environment", environmentMap);
		material0->Set("u_EnvironmentRot", glm::mat3(glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(1, 0, 0))));
		...
		reflectiveMat->Set("u_EnvironmentRotation", 
		...
		/////////////////////////////////// SKYBOX ///////////////////////////////////////////////
		{
			...
			// TODO: send the rotation to apply to the skybox
			skyboxMat->Set("u_EnvironmentRotation",
				glm::mat3(glm::rotate(glm::mat4(1.0f),
				glm::radians(90.0f),
				glm::vec3(1, 0, 0))));
